    ...
    public class ShippingCompanyDomain : DefaultDomains.MasterDomain
    {
        ...
        public ShippingCompany Post(ShippingCompany shippingCompany)
        {
            try
            {
                ...
                SQL.AppendLine("     '" + Functions.RemoveCharSpecial(Functions.NoQuote(shippingCompany.CEP)) + "',");
        ...
        public ShippingCompany Put(ShippingCompany shippingCompany)
        {
            try
            {
                ...
                SQL.AppendLine("    CEP = '" + Functions.RemoveCharSpecial(Functions.NoQuote(shippingCompany.CEP)) + "',");
        ...
        {
            if (shippingCompany.CompanyId <= 0)
            {
        ...
        private ShippingCompany Fill(DataRow row)
        {
            ...
            shippingCompany.CompanyId = long.Parse(row["CompanyId"].ToString());
